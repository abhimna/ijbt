...
public class TermsAndConditionFragment extends Fragment {
	...
	private void setBodyUI() {
		...
		webView.loadUrl("http://52.36.237.68/app/services/pages/Term_of_Services.html");
	...
	private void defaultactionBar() {
		...
		Middle_text.setText("Terms and Condition");
	...
	// .findViewById(R.id.txt_cancel);
	//
	// Middle_text.setText("Terms of Services");
	// txt_reset.setVisibility(View.INVISIBLE);
	// Middle_text.setVisibility(View.VISIBLE);
	// txt_cancel.setVisibility(View.INVISIBLE);
