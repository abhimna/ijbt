...
public class GlobalConfig {
	...
	public static void showToast(Context _ac, String msg) {
		Toast.makeText(_ac, msg, Toast.LENGTH_SHORT).show();
	}
	...
	public static void changeActivity(Activity currentActivity,
			Class<? extends Activity> class_activity) {
	 ...
	 */
	public static void changeActivityThroughPackage(Activity currentActivity,
			String str_activity_name) {

		try {
			String packageName = currentActivity.getApplicationContext()
					.getPackageName();
