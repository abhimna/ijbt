...
public class SuggestionAdapter extends BaseAdapter implements
		IJBTResponseController {
	private ArrayList<GsonParseSuggestion.Suggestions> alSuggestions = new ArrayList();
	...
	public SuggestionAdapter(Activity paramActivity,
			ArrayList<GsonParseSuggestion.Suggestions> paramArrayList) {
	...
	public View getView(final int paramInt, View paramView,
		...
		Picasso.with(this.mactivity)
				.load(URLFactory.imageUrl
						+ ((GsonParseSuggestion.Suggestions) this.alSuggestions
		...
		localViewHolder.tvUsername
				.setText(((GsonParseSuggestion.Suggestions) this.alSuggestions
						.get(paramInt)).getUser_name());
		localViewHolder.ivProfile
				.setOnClickListener(new OnClickListener() {
					public void onClick(View paramAnonymousView) {
						String str = ((GsonParseSuggestion.Suggestions) SuggestionAdapter.this.alSuggestions
								.get(paramInt)).getUserid();
						if (str.equals(SuggestionAdapter.this.userid)) {
							SuggestionAdapter.this.mactivity
									.getFragmentManager()
									.beginTransaction()
									...
									.add(R.id.container,
											ProfileFragment
													.newInstance((CommonFragmentActivity) SuggestionAdapter.this.mactivity))
...
//												.parseColor("#ffffff"));
	...
	public void setData(ArrayList<Suggestions> suggestions) {
		this.alSuggestions = suggestions;
		notifyDataSetChanged();
